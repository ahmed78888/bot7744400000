...
GAME_MESSAGE = "⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب بودا\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉', url =f"https://t.me/CG_G11")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉\n\nمرحبا بك في قسم العاب بودا 3D\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉\n\n★¦مرحبا بك في قسم العاب بودا\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب بودا', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐉', url =f"https://t.me/CG_G11")              
                 ],[
                InlineKeyboardButton(
